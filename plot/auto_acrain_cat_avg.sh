...
do
  ...
  ln -sf /home/miayao/maple_ncu/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc maple_48/T1/.
  ln -sf /home/miayao/maple_adjust_vector/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc maple_144/T1/.
  ln -sf /home/miayao/com_weak_WRF/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc com/T1/.
  ln -sf /home/miayao/WRF_result/rainfall_verification/${case_name}/$now/categorical_${now}_WRF_DI.nc wrf/T1/.
...
do
  ...
  ln -sf /home/miayao/maple_ncu/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc maple_48/T2/.
  ln -sf /home/miayao/maple_adjust_vector/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc maple_144/T2/.
  ln -sf /home/miayao/com_weak_WRF/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc com/T2/.
  ln -sf /home/miayao/WRF_result/rainfall_verification/${case_name}/$now/categorical_${now}_WRF_DI.nc wrf/T2/.
...
do
  ...
  ln -sf /home/miayao/maple_ncu/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc maple_48/T3/.
  ln -sf /home/miayao/maple_adjust_vector/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc maple_144/T3/.
  ln -sf /home/miayao/com_weak_WRF/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc com/T3/.
  ln -sf /home/miayao/WRF_result/rainfall_verification/${case_name}/$now/categorical_${now}_WRF_DI.nc wrf/T3/.
...
do
  ...
  ln -sf /home/miayao/maple_ncu/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc maple_48/All/.
  ln -sf /home/miayao/maple_adjust_vector/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc maple_144/All/.
  ln -sf /home/miayao/com_weak_WRF/rainfall_verification/${case_name}/$now/categorical_${now}_alldata_DI.nc com/All/.
  ln -sf /home/miayao/WRF_result/rainfall_verification/${case_name}/$now/categorical_${now}_WRF_DI.nc wrf/All/.
